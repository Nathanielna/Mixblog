            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="active"><a href="${pageContext.request.contextPath}/usercart">消费清单</a></li>
                        ...
                        <div class="col-lg-6">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                     ...
                                     <c:forEach items="${consumption}" var="c">
                                        <tr>
                                            <td><fmt:formatDate value="${c.ccreatetime }" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                            <td>${c.cmoney }</td>
                                            <td>${c.cpurpose }</td>
                                        </tr>
                                        </c:forEach> 
